...
export default function Inputin({ title, placeholder, type, value, onChange, validate, validator, validateExec, }) {
    ...
    return (React.createElement("div", { className: "input-group mb-3" }, React.createElement("span", { className: "input-group-text", id: "basic-addon1" }, title), React.createElement("input", { type: type, className: `form-control ${setClassName()}`, placeholder: placeholder, "aria-label": placeholder, "aria-describedby": "basic-addon1", value: value, onChange: changeInput, onBlur: onBlurHandler })));
}
